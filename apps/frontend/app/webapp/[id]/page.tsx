...
export default function RequestDetailPage() {
  ...
  useEffect(() => {
    ...
    tg?.expand?.();
    if (!params?.id) return;
    apiGet(`/api/webapp/requests/${params.id}`, { headers: { "X-Telegram-Init-Data": tg?.initData || "" } })
      .then(setData)
  ...
  return (
    <div className="grid">
      <div className="card">
        ...
        <p>Слот доставки: {data.delivery_slot}</p>
      ...
      <div className="card">
        <h4 style={{ marginTop: 0 }}>История изменений</h4>
